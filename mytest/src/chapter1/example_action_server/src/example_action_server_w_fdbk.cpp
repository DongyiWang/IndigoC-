...
ExampleActionServer::ExampleActionServer():as_(nh_, "time_action", boost::bind(&ExampleActionServer::executeCB, this, _1), false)
{
...
int main(int argc, char** argv){
    ros::init(argc, argv, "time_action_server_node");
